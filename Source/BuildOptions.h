...
//	Platform options
//
#undef DAEDALUS_COMPRESSED_ROM_SUPPORT // Define this to enable support for
                                       // compressed Roms(zip'ed). If you define
                                       // this, you will need to add unzip.c and
                                       // ioapi.c to the project too. (Located
                                       // at Source/Utility/Zip/)
#undef DAEDALUS_ENABLE_DYNAREC  // Define this is dynarec is supported on the
                                // platform
...
#undef DAEDALUS_ENDIAN_MODE // Define this to specify whether the platform is
...
//
//	Set up your preprocessor flags to search Source/SysXYZ/Include first,
//where XYZ is your target platform 	If certain options are not defined, defaults
//are provided below
//
#include "Platform.h"
...
// global memory. Const is a function attribute which says that a function does
// not read/modify any global memory.
...
//
//	Configuration options. These are not really platform-specific, but
