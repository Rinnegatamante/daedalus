...
OpCode	GetInverseBranch( OpCode op_code )
{
        ...
        case OP_REGIMM:
                ...
                {
                case RegImmOp_BLTZ:		op_code.regimm_op =
RegImmOp_BGEZ;	break;
                case RegImmOp_BGEZ:		op_code.regimm_op =
RegImmOp_BLTZ;	break;
                case RegImmOp_BLTZL:	op_code.regimm_op = RegImmOp_BGEZL;
break; case RegImmOp_BGEZL:	op_code.regimm_op = RegImmOp_BLTZL;	break;
                case RegImmOp_BLTZAL:	op_code.regimm_op =
RegImmOp_BGEZAL;break; case RegImmOp_BGEZAL:	op_code.regimm_op =
RegImmOp_BLTZAL;break; case RegImmOp_BLTZALL:	op_code.regimm_op =
RegImmOp_BGEZALL;break; case RegImmOp_BGEZALL:	op_code.regimm_op =
RegImmOp_BLTZALL;break; default: NODEFAULT; break;
                }
                break;
        ...
        case OP_COPRO1:
                if( op_code.cop1_op == Cop1Op_BCInstr )
                {
                        ...
                        {
                        case Cop1BCOp_BC1F:		op_code.cop1_bc =
Cop1BCOp_BC1T;	break;
                        case Cop1BCOp_BC1T:		op_code.cop1_bc =
Cop1BCOp_BC1F;	break;
                        case Cop1BCOp_BC1FL:	op_code.cop1_bc =
Cop1BCOp_BC1TL;	break;
                        case Cop1BCOp_BC1TL:	op_code.cop1_bc =
Cop1BCOp_BC1FL;	break;
                        }
                }
                break;
        }
...
namespace
{
        OpCode	UpdateBranchOffset( OpCode op_code, u32 branch_location, u32
target_location )
        {
                DAEDALUS_ASSERT( (target_location & 0x3) == 0, "Target location
is not 4-byte aligned!" );

                s32		offset( target_location - branch_location );
// signed
        ...
        OpCode	UpdateJumpTarget( OpCode op_code, u32 jump_location, u32
target_location )
        {
...
); break; case OP_BEQ: case OP_BNE: case OP_BLEZ: case OP_BGTZ: case OP_BEQL:
        case OP_BNEL:
        case OP_BLEZL:
        case OP_BGTZL:
                op_code = UpdateBranchOffset( op_code, op_address,
target_address ); break;
        ...
        case OP_REGIMM:
                ...
                case RegImmOp_BGEZALL:
                        op_code = UpdateBranchOffset( op_code, op_address,
target_address ); break; default: NODEFAULT; break;
                }
                break;
        ...
        case OP_COPRO1:
                if( op_code.cop1_op == Cop1Op_BCInstr )
                {
                        ...
                        case Cop1BCOp_BC1FL:
                        case Cop1BCOp_BC1TL:
                                op_code = UpdateBranchOffset( op_code,
op_address, target_address ); break;
                        }
                }
                break;
        }
...
ER4300BranchType	GetInverseBranch( ER4300BranchType type )
{
        ...
        DAEDALUS_ASSERT( gInverseBranchTypes[ inverse ] == type, "Inconsistant
inverse branch type" );
...
#endif
  // We pass the type in for efficiency - check that it's correct in debug
  // though This already checked
  // DAEDALUS_ASSERT( GetBranchType( op_code ) == type, "Specified type is
  // inconsistant with op code" );
