...
inline u32 Vector2ColourClampedVFPU(const v4 *col_in) {
  ...
  __asm__ volatile(
      ...
      "lv.q		R001, %2\n"      // Load SCALE into R001 (we know it's
                                         // aligned)
      ...
      "vf2in.q	R000, R000, 0\n" // R000 = (s32)(R000) << 0		- or is scale
                                 // applied before? could use << 8 to scale to
                                 // 0..255? Would need to be careful of 1.0
                                 // overflowing to 256
      "usv.q		R000, %0\n" // Save out value
...
c32::c32(const v4 &colour) : mColour(Vector2ColourClamped(colour)) {}
