...
static const u8 FourToEight[] = {0x00, 0x11, 0x22, 0x33, 0x44, 0x55,
...
static void ConvertCI4T(const TileDestInfo &dsti, const TextureInfo &ti) {
  ...
  typedef void (*ConvertFunction)(const TileDestInfo &dsti,
  ...
  bool ConvertTile(const TextureInfo &ti, void *texels, NativePf8888 *palette,
    ...
    DAEDALUS_ASSERT(texture_format == TexFmt_8888,
                    "OSX should only use RGBA 8888 textures");
