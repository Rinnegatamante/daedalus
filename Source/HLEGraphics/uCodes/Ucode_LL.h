...
// IS called Last Legion, but is used for several other games like: Dark Rift,
// Toukon Road, Toukon Road 2.

//*****************************************************************************
// Only thing I can't figure out why are the characters on those games invisble?
// Dark Rift runs properly without custom microcodes, and has the same
// symptoms... We need Turbo3D ucode support, actually a modified version of it,
// thanks Gonetz for the info :D
...
void DLParser_TexRect_Last_Legion(MicroCodeCommand command) {
  ...
  // Note : The only difference with normal texrect is that these are in a
  // different order!
