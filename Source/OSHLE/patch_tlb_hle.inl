...
TEST_DISABLE_TLB_FUNCS
	...
	auto w {gGPR[REG_a0]._u32_0};
	auto x {gGPR[REG_a1]._u32_0};
	auto y {gGPR[REG_a2]._u32_0};
	auto z {gGPR[REG_a3]._u32_0};
	auto a {Read32Bits(gGPR[REG_sp]._u32_0 + 0x10)};
	auto b {Read32Bits(gGPR[REG_sp]._u32_0 + 0x14)};
