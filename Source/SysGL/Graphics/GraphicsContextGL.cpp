...
// FIXME: This is global to lots of SysGL stuff. Wrap it up elsewhere, and keep
// this file for the graphics side of things.
...
void GraphicsContextGL::ClearAllSurfaces() {
  // FIXME: this should clear/flip a couple of times to ensure the front and
  // backbuffers are cleared. Not sure if it's necessary...
  ClearToBlack();
}
