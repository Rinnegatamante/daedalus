...
private:
  void ParseAndDisplayString(const char *p_string,
                             ETerminalColour default_colour);
...
void IDebugConsole::ParseAndDisplayString(const char *p_string,
                                          ETerminalColour default_colour) {
...
void IDebugConsole::MsgOverwriteStart() { printf(kTerminalSaveCursor); }
