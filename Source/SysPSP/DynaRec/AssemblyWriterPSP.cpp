...
//	register. If this can be performed in a single op, the second opcode is
//NOP. 	This is useful for splitting a constant load and using the branch delay
//slot.

void CAssemblyWriterPSP::GetLoadConstantOps(EPspReg reg, s32 value,
                                            PspOpCode *p_op1,
                                            PspOpCode *p_op2) {
  PspOpCode op1{};
  PspOpCode op2{};
...
void CAssemblyWriterPSP::LoadConstant(EPspReg reg, s32 value) {
  ...
  // There may not be a second op if the low bits are 0, or the constant is
  // small
  if (op2._u32 != 0) {
    AppendOp(op2);
  }
...
void CAssemblyWriterPSP::LoadRegister(EPspReg reg_dst, OpCodeValue load_op,
                                      EPspReg reg_base, s16 offset) {
  PspOpCode op_code{};
  op_code._u32 = 0;
...
void CAssemblyWriterPSP::StoreRegister(EPspReg reg_src, OpCodeValue store_op,
                                       EPspReg reg_base, s16 offset) {
  PspOpCode op_code{};
  op_code._u32 = 0;
...
void CAssemblyWriterPSP::LWC1(EPspFloatReg reg_dst, EPspReg reg_base,
                              s16 offset) {
  PspOpCode op_code{};
  op_code._u32 = 0;
...
void CAssemblyWriterPSP::SWC1(EPspFloatReg reg_src, EPspReg reg_base,
                              s16 offset) {
  PspOpCode op_code{};
  op_code._u32 = 0;
...
CJumpLocation CAssemblyWriterPSP::BranchOp(EPspReg a, OpCodeValue op, EPspReg b,
                                           CCodeLabel target,
                                           bool insert_delay) {
  ...
  op_code.rt = b;
  op_code.offset =
      s16((offset - 4) >> 2); // Adjust for incremented PC and ignore lower bits
  AppendOp(op_code);
...
CJumpLocation CAssemblyWriterPSP::BNE(EPspReg a, EPspReg b, CCodeLabel target,
                                      bool insert_delay) {
...
CJumpLocation CAssemblyWriterPSP::BEQ(EPspReg a, EPspReg b, CCodeLabel target,
                                      bool insert_delay) {
...
CJumpLocation CAssemblyWriterPSP::BNEL(EPspReg a, EPspReg b, CCodeLabel target,
                                       bool insert_delay) {
...
CJumpLocation CAssemblyWriterPSP::BEQL(EPspReg a, EPspReg b, CCodeLabel target,
                                       bool insert_delay) {
...
CJumpLocation CAssemblyWriterPSP::BLEZ(EPspReg a, CCodeLabel target,
                                       bool insert_delay) {
...
CJumpLocation CAssemblyWriterPSP::BGTZ(EPspReg a, CCodeLabel target,
                                       bool insert_delay) {
...
CJumpLocation CAssemblyWriterPSP::BranchRegImmOp(EPspReg a, ERegImmOp op,
                                                 CCodeLabel target,
                                                 bool insert_delay) {
  CJumpLocation branch_location(mpCurrentBuffer->GetJumpLocation());
  s32 offset(branch_location.GetOffset(target));
...
CJumpLocation CAssemblyWriterPSP::BLTZ(EPspReg a, CCodeLabel target,
                                       bool insert_delay) {
...
CJumpLocation CAssemblyWriterPSP::BGEZ(EPspReg a, CCodeLabel target,
                                       bool insert_delay) {
...
CJumpLocation CAssemblyWriterPSP::BLTZL(EPspReg a, CCodeLabel target,
                                        bool insert_delay) {
...
CJumpLocation CAssemblyWriterPSP::BGEZL(EPspReg a, CCodeLabel target,
                                        bool insert_delay) {
...
void CAssemblyWriterPSP::EXT(EPspReg reg_dst, EPspReg reg_src, u32 size,
                             u32 lsb) {
  PspOpCode op_code{};
  op_code._u32 = 0;
  op_code.op = 0x1F;
...
void CAssemblyWriterPSP::INS(EPspReg reg_dst, EPspReg reg_src, u32 msb,
                             u32 lsb) {
  PspOpCode op_code{};
  op_code._u32 = 0;
  op_code.op = 0x1F;
...
void CAssemblyWriterPSP::SpecOpLogical(EPspReg rd, EPspReg rs, ESpecOp op,
                                       EPspReg rt) {
  PspOpCode op_code{};
  op_code._u32 = 0;
  op_code.op = OP_SPECOP;
...
void CAssemblyWriterPSP::Cop1Op(ECop1Op cop1_op, EPspFloatReg fd,
                                EPspFloatReg fs, ECop1OpFunction cop1_funct,
                                EPspFloatReg ft) {
  PspOpCode op_code{};
  op_code._u32 = 0;
...
void CAssemblyWriterPSP::ADD_S(EPspFloatReg fd, EPspFloatReg fs,
                               EPspFloatReg ft) {
...
void CAssemblyWriterPSP::SUB_S(EPspFloatReg fd, EPspFloatReg fs,
                               EPspFloatReg ft) {
...
void CAssemblyWriterPSP::MUL_S(EPspFloatReg fd, EPspFloatReg fs,
                               EPspFloatReg ft) {
...
void CAssemblyWriterPSP::DIV_S(EPspFloatReg fd, EPspFloatReg fs,
                               EPspFloatReg ft) {
...
void CAssemblyWriterPSP::CMP_S(EPspFloatReg fs, ECop1OpFunction cmp_op,
                               EPspFloatReg ft) {
...
CJumpLocation CAssemblyWriterPSP::BranchCop1(ECop1BCOp bc_op, CCodeLabel target,
                                             bool insert_delay) {
  CJumpLocation branch_location(mpCurrentBuffer->GetJumpLocation());
  s32 offset(branch_location.GetOffset(target));
