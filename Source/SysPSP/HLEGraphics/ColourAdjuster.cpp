...
void CColourAdjuster::Process( DaedalusVtx * p_vertices, u32 num_verts ) const
{
	...
	switch( mSetMask )
	{
		...
		default:
			{
				auto		clear_bits {~mSetMask};
				auto	set_bits {mSetColour.GetColour() & mSetMask};
...
void	CColourAdjuster::Set( u32 mask, c32 colour )
{
	...
	auto	current {mSetColour.GetColour()};
	auto	col {colour.GetColour()};
...
void	CColourAdjuster::Modulate( u32 mask, c32 colour )
{
	...
	auto		current {mModulateColour.GetColour()};
	auto	col {colour.GetColour()};
...
void	CColourAdjuster::Subtract( u32 mask, c32 colour )
{
	...
	auto		current {mSubtractColour.GetColour()};
	auto		col {colour.GetColour() };
