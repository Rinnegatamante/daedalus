...
static const u32 kPlaceholderSize =
    kPlaceholderTextureWidth * kPlaceholderTextureHeight;
...
#define BLEND_MODE_MAKER                                                       \
  {                                                                            \
    const u32 PSPtxtFunc[5] = {GU_TFX_MODULATE, GU_TFX_BLEND, GU_TFX_ADD,      \
                               GU_TFX_REPLACE, GU_TFX_DECAL};                  \
    const u32 PSPtxtA[2] = {GU_TCC_RGB, GU_TCC_RGBA};                          \
    switch (gDBlend.ForceRGB) {                                                \
    case 1:                                                                    \
      details.ColourAdjuster.SetRGB(c32::White);                               \
      break;                                                                   \
    case 2:                                                                    \
      details.ColourAdjuster.SetRGB(c32::Black);                               \
      break;                                                                   \
    case 3:                                                                    \
      details.ColourAdjuster.SetRGB(c32::Red);                                 \
      break;                                                                   \
    case 4:                                                                    \
      details.ColourAdjuster.SetRGB(c32::Green);                               \
      break;                                                                   \
    case 5:                                                                    \
      details.ColourAdjuster.SetRGB(c32::Blue);                                \
      break;                                                                   \
    case 6:                                                                    \
      details.ColourAdjuster.SetRGB(c32::Magenta);                             \
      break;                                                                   \
    case 7:                                                                    \
    ...
    case 1:                                                                    \
      ...
      break;                                                                   \
    case 2:                                                                    \
      details.ColourAdjuster.SetA(details.PrimColour.ReplicateAlpha());        \
      break;                                                                   \
    case 3:                                                                    \
      details.ColourAdjuster.SetA(details.EnvColour);                          \
      break;                                                                   \
    case 4:                                                                    \
      details.ColourAdjuster.SetA(details.EnvColour.ReplicateAlpha());         \
      break;                                                                   \
    }                                                                          \
    ...
    case 1:                                                                    \
      ...
      break;                                                                   \
    case 2:                                                                    \
      details.ColourAdjuster.ModulateRGB(details.PrimColour.ReplicateAlpha()); \
      break;                                                                   \
    case 3:                                                                    \
      details.ColourAdjuster.ModulateRGB(details.EnvColour);                   \
      break;                                                                   \
    case 4:                                                                    \
      details.ColourAdjuster.ModulateRGB(details.EnvColour.ReplicateAlpha());  \
      break;                                                                   \
    }                                                                          \
    switch (gDBlend.ModA) {                                                    \
    case 1:                                                                    \
      ...
      break;                                                                   \
    case 2:                                                                    \
      details.ColourAdjuster.ModulateA(details.PrimColour.ReplicateAlpha());   \
      break;                                                                   \
    case 3:                                                                    \
      details.ColourAdjuster.ModulateA(details.EnvColour);                     \
      break;                                                                   \
    case 4:                                                                    \
      details.ColourAdjuster.ModulateA(details.EnvColour.ReplicateAlpha());    \
      break;                                                                   \
    }                                                                          \
    switch (gDBlend.ModRGBA) {                                                 \
    case 1:                                                                    \
      details.ColourAdjuster.ModulateRGBA(details.PrimColour);                 \
      break;                                                                   \
    case 2:                                                                    \
      details.ColourAdjuster.ModulateRGBA(                                     \
          details.PrimColour.ReplicateAlpha());                                \
      break;                                                                   \
    case 3:                                                                    \
      details.ColourAdjuster.ModulateRGBA(details.EnvColour);                  \
      break;                                                                   \
    case 4:                                                                    \
      details.ColourAdjuster.ModulateRGBA(details.EnvColour.ReplicateAlpha()); \
      break;                                                                   \
    }                                                                          \
    switch (gDBlend.SubRGB) {                                                  \
    case 1:                                                                    \
      details.ColourAdjuster.SubtractRGB(details.PrimColour);                  \
      break;                                                                   \
    case 2:                                                                    \
      details.ColourAdjuster.SubtractRGB(details.PrimColour.ReplicateAlpha()); \
      break;                                                                   \
    case 3:                                                                    \
      details.ColourAdjuster.SubtractRGB(details.EnvColour);                   \
      break;                                                                   \
    case 4:                                                                    \
      details.ColourAdjuster.SubtractRGB(details.EnvColour.ReplicateAlpha());  \
      break;                                                                   \
    }                                                                          \
    switch (gDBlend.SubA) {                                                    \
    case 1:                                                                    \
      details.ColourAdjuster.SubtractA(details.PrimColour);                    \
      break;                                                                   \
    case 2:                                                                    \
      details.ColourAdjuster.SubtractA(details.PrimColour.ReplicateAlpha());   \
      break;                                                                   \
    case 3:                                                                    \
      details.ColourAdjuster.SubtractA(details.EnvColour);                     \
      break;                                                                   \
    case 4:                                                                    \
      details.ColourAdjuster.SubtractA(details.EnvColour.ReplicateAlpha());    \
      break;                                                                   \
    }                                                                          \
    switch (gDBlend.SubRGBA) {                                                 \
    case 1:                                                                    \
      details.ColourAdjuster.SubtractRGBA(details.PrimColour);                 \
      break;                                                                   \
    case 2:                                                                    \
      details.ColourAdjuster.SubtractRGBA(                                     \
          details.PrimColour.ReplicateAlpha());                                \
      break;                                                                   \
    case 3:                                                                    \
      details.ColourAdjuster.SubtractRGBA(details.EnvColour);                  \
      break;                                                                   \
    case 4:                                                                    \
      details.ColourAdjuster.SubtractRGBA(details.EnvColour.ReplicateAlpha()); \
      break;                                                                   \
    }                                                                          \
    if (gDBlend.AOpaque)                                                       \
    ...
    sceGuTexFunc(PSPtxtFunc[(gDBlend.TXTFUNC >> 1) % 6],                       \
                 PSPtxtA[gDBlend.TXTFUNC & 1]);                                \
  }
...
RendererPSP::RendererPSP() {
  ...
  mFillBlendStates = new CBlendStates;
  {
    ...
    alpha_settings->AddTermConstant(
        new CBlendConstantExpressionValue(BC_SHADE));
    colour_settings->AddTermConstant(
        new CBlendConstantExpressionValue(BC_SHADE));
  ...
  for (u32 y = 0; y < kPlaceholderTextureHeight; ++y) {
    for (u32 x = 0; x < kPlaceholderTextureWidth; ++x) {
      gPlaceholderTexture[texel_idx] =
          ((x & 1) == (y & 1)) ? COL_MAGENTA : COL_BLACK;
      gSelectedTexture[texel_idx] =
          ((x & 1) == (y & 1)) ? COL_GREEN : COL_BLACK;
...
void RendererPSP::RestoreRenderStates() {
  ...
  // This was breaking Glover's sky and Rocket Robot's right/left sides of the
  // screen when in un/scaled mode I think the problem was that GetScreenSize for
  // PSP only returns 480x240, we should get the current screen size? Or get
  // scissor.left/right/top/bottom, then pass them trough ConvertN64ToScreen and
  // then use those to set PSP scissors sceGuScissor(0,0, width,height);
  ...
  // &gMatrixIdentity ) );
  sceGuSetMatrix(GU_VIEW,
                 reinterpret_cast<const ScePspFMatrix4 *>(&gMatrixIdentity));
  sceGuSetMatrix(GU_MODEL,
                 reinterpret_cast<const ScePspFMatrix4 *>(&gMatrixIdentity));
}
...
RendererPSP::SBlendStateEntry RendererPSP::LookupBlendState(u64 mux,
                                                            bool two_cycles) {
#ifdef DAEDALUS_DEBUG_DISPLAYLIST
  ...
  // Top 8 bits are never set - use the very top one to differentiate between
  // 1/2 cycles
  ...
  // Blendmodes with Inexact blends either get an Override blend or a Default
  // blend (GU_TFX_MODULATE) If its not an Inexact blend then we check if we
  // need to Force a blend mode none the less// Salvy
  //
  ...
  printf("Adding %08x%08x - %d cycles - %s\n", u32(mux >> 32), u32(mux),
         two_cycles ? 2 : 1,
         entry.States->IsInexact()
             ? IsCombinerStateDefault(mux) ? "Inexact(Default)"
                                           : "Inexact(Override)"
             : entry.OverrideFunction == nullptr ? "Auto" : "Forced");
#endif
...
void RendererPSP::RenderTriangles(DaedalusVtx *p_vertices, u32 num_vertices,
  ...
  if (mTnL.Flags.Texture) {
    ...
    if (texture && (mTnL.Flags._u32 & (TNL_LIGHT | TNL_TEXGEN)) !=
      ...
      if (g_ROM.ZELDA_HACK &&
          (gRDPOtherMode.L == 0x0c184241)) //&& ti.GetFormat() == G_IM_FMT_I &&
                                           //(ti.GetWidth() == 64)
      {
        scale_x *= 0.5f;
        scale_y *= 0.5f;
  ...
  RenderUsingCurrentBlendMode(p_vertices, num_vertices, DRAW_MODE,
                              GU_TRANSFORM_3D, disable_zbuffer);
}

inline void RendererPSP::RenderFog(DaedalusVtx *p_vertices, u32 num_vertices,
                                   u32 triangle_mode, u32 render_flags) {
  // This will render a second pass on triangles that are fog enabled to blend
  // in the fog color as a function of depth(alpha) //Corn
  //
  // if( gRDPOtherMode.c1_m1a==3 || gRDPOtherMode.c1_m2a==3 ||
  // gRDPOtherMode.c2_m1a==3 || gRDPOtherMode.c2_m2a==3 )
  {
    // sceGuShadeModel(GU_SMOOTH);
    sceGuDepthFunc(GU_EQUAL); // Make sure to only blend on pixels that has been
                              // rendered on first pass //Corn
    sceGuDepthMask(GL_TRUE); // GL_TRUE to disable z-writes, no need to write to
                             // zbuffer for second pass //Corn
    ...
    sceGuDrawArray(triangle_mode, render_flags, num_vertices, nullptr,
                   p_vertices);
...
void RendererPSP::RenderUsingCurrentBlendMode(DaedalusVtx *p_vertices,
                                              u32 num_vertices,
                                              u32 triangle_mode,
                                              u32 render_mode,
                                              bool disable_zbuffer) {
  ...
  //
  if ((gRDPOtherMode.text_filt != G_TF_POINT) |
  ...
  // Initiate Alpha test
  //
  if ((gRDPOtherMode.alpha_compare == G_AC_THRESHOLD) &&
      !gRDPOtherMode.alpha_cvg_sel) {
    u8 alpha_threshold{mBlendColour.GetA()};
    sceGuAlphaFunc((alpha_threshold | g_ROM.ALPHA_HACK) ? GU_GEQUAL
                                                        : GU_GREATER,
                   alpha_threshold, 0xff);
    sceGuEnable(GU_ALPHA_TEST);
  } else if (gRDPOtherMode.cvg_x_alpha) {
    // Going over 0x70 breaks OOT, but going lesser than that makes lines on
    // games visible...ex: Paper Mario. Also going over 0x30 breaks the birds in
    // Tarzan :(. Need to find a better way to leverage this.
  ...
  switch (cycle_mode) {
  case CYCLE_COPY:
    blend_entry.States = mCopyBlendStates;
    break;
  case CYCLE_FILL:
    blend_entry.States = mFillBlendStates;
    break;
  case CYCLE_1CYCLE:
    blend_entry = LookupBlendState(mMux, false);
    break;
  case CYCLE_2CYCLE:
    blend_entry = LookupBlendState(mMux, true);
    break;
  }
  ...
  //
  if (DebugBlendmode(p_vertices, num_vertices, triangle_mode, render_flags,
                     mMux))
    return;
#endif

  // This check is for inexact blends which were handled either by a custom
  // blendmode or auto blendmode thing
  //
  if (blend_entry.OverrideFunction != nullptr) {
#ifdef DAEDALUS_DEBUG_DISPLAYLIST
    // Used for dumping mux and highlight inexact blend
    //
    DebugMux(blend_entry.States, p_vertices, num_vertices, triangle_mode,
             render_flags, mMux);
#endif
    ...
    if (mTnL.Flags.Fog) {
      auto *p_FogVtx = static_cast<DaedalusVtx *>(
          sceGuGetMemory(num_vertices * sizeof(DaedalusVtx)));
    ...
    RenderUsingRenderSettings(blend_entry.States, p_vertices, num_vertices,
                              triangle_mode, render_flags);
  } else {
...
void RendererPSP::RenderUsingRenderSettings(const CBlendStates *states,
                                            DaedalusVtx *p_vertices,
                                            u32 num_vertices, u32 triangle_mode,
                                            u32 render_flags) {
  ...
  if (mTnL.Flags.Fog) {
    p_FogVtx = static_cast<DaedalusVtx *>(
        sceGuGetMemory(num_vertices * sizeof(DaedalusVtx)));
    memcpy(p_FogVtx, p_vertices, num_vertices * sizeof(DaedalusVtx));
  ...
  for (u32 i{}; i < states->GetNumStates(); ++i) {
    ...
    bool install_texture0(settings->UsesTexture0() ||
                          alpha_settings->UsesTexture0());
    bool install_texture1(settings->UsesTexture1() ||
                          alpha_settings->UsesTexture1());
    ...
    // TODO: this nobbles the existing diffuse colour on each pass. Need to use
    // a second buffer...
    if (i > 0) {
    ...
    if (install_texture0 || install_texture1) {
      ...
      sceGuTexFunc(tfx,
                   out.BlendAlphaMode == PBAM_RGB ? GU_TCC_RGB : GU_TCC_RGBA);
      ...
      if (g_ROM.T1_HACK) {
        ...
        if (install_texture1 && texture1 && mTnL.Flags.Texture &&
            (mTnL.Flags._u32 & (TNL_LIGHT | TNL_TEXGEN)) !=
                (TNL_LIGHT | TNL_TEXGEN)) {
...
void RendererPSP::TexRect(u32 tile_idx, const v2 &xy0, const v2 &xy1,
                          TexCoord st0, TexCoord st1) {
  mTnL.Flags.Fog = 0; // For now we force fog off for textrect, normally it
                      // should be fogged when depth_source is set //Corn

  UpdateTileSnapshots(tile_idx);

  // NB: we have to do this after UpdateTileSnapshot, as it set up mTileTopLeft
  // etc.
  ...
  if (gGlobalPreferences.ViewportType == VT_FULLSCREEN_HD) {
    screen0.x = roundf(roundf(HD_SCALE * xy0.x) * mN64ToScreenScale.x +
                       59); // 59 in translate is an ugly hack that only work on
                            // 480x272 display//Corn
    screen0.y =
        roundf(roundf(xy0.y) * mN64ToScreenScale.y + mN64ToScreenTranslate.y);

    screen1.x = roundf(roundf(HD_SCALE * xy1.x) * mN64ToScreenScale.x +
                       59); // 59 in translate is an ugly hack that only work on
                            // 480x272 display//Corn
    screen1.y =
        roundf(roundf(xy1.y) * mN64ToScreenScale.y + mN64ToScreenTranslate.y);
  } else {
...
#ifdef DAEDALUS_DEBUG_DISPLAYLIST
  DL_PF("    Screen:  %.1f,%.1f -> %.1f,%.1f", screen0.x, screen0.y, screen1.x,
        screen1.y);
  ...
  auto *p_vertices =
      static_cast<DaedalusVtx *>(sceGuGetMemory(2 * sizeof(DaedalusVtx)));
  ...
  RenderUsingCurrentBlendMode(p_vertices, 2, GU_SPRITES, GU_TRANSFORM_2D,
                              gRDPOtherMode.depth_source ? false : true);
#else
  //	To be used with TRIANGLE_STRIP, which requires 40% less verts than
  //TRIANGLE 	For reference for future ports and if SPRITES( which uses %60 less
  //verts than TRIANGLE) causes issues
  DaedalusVtx *p_vertices =
      static_cast<DaedalusVtx *>(sceGuGetMemory(4 * sizeof(DaedalusVtx)));
  ...
  RenderUsingCurrentBlendMode(p_vertices, 4, GU_TRIANGLE_STRIP, GU_TRANSFORM_2D,
                              gRDPOtherMode.depth_source ? false : true);
#endif
...
void RendererPSP::TexRectFlip(u32 tile_idx, const v2 &xy0, const v2 &xy1,
                              TexCoord st0, TexCoord st1) {
  mTnL.Flags.Fog = 0; // For now we force fog off for textrect, normally it
                      // should be fogged when depth_source is set //Corn
  ...
  v2 screen0;
  v2 screen1;
  // FIXME(strmnnrmn): why is VT_FULLSCREEN_HD code in TexRect() not also done
  // here?
  ConvertN64ToScreen(xy0, screen0);
  ConvertN64ToScreen(xy1, screen1);
  ...
  // FIXME(strmnnrmn): shouldn't this pass gRDPOtherMode.depth_source ? false :
  // true for the disable_zbuffer arg, as TextRect()?
  RenderUsingCurrentBlendMode(p_vertices, 4, GU_TRIANGLE_STRIP, GU_TRANSFORM_2D,
                              true);
...
void RendererPSP::FillRect(const v2 &xy0, const v2 &xy1, u32 color) {
  /*
          if ( (gRDPOtherMode._u64 & 0xffff0000) == 0x5f500000 )	//Used by
     Wave Racer
          {
                  // this blend mode is mem*0 + mem*1, so we don't need to
     render it... Very odd! DAEDALUS_ERROR("	mem*0 + mem*1 - skipped");
                  return;
          }
  */
  // This if for C&C - It might break other stuff (I'm not sure if we should
  // allow alpha or not..)
  // color |= 0xff000000;
  ...
  // FIXME(strmnnrmn): shouldn't this pass gRDPOtherMode.depth_source ? false :
  // true for the disable_zbuffer arg, as TexRect()?
...
void RendererPSP::Draw2DTexture(f32 x0, f32 y0, f32 x1, f32 y1, f32 u0, f32 v0,
                                f32 u1, f32 v1, const CNativeTexture *texture) {
  ...
  // Handle large images (width > 512) with blitting, since the PSP HW can't
  // handle Handling height > 512 doesn't work well? Ignore for now.
  if (u1 >= 512) {
  ...
  sceGuDrawArray(GU_TRIANGLE_STRIP,
                 GU_TEXTURE_32BITF | GU_VERTEX_32BITF | GU_TRANSFORM_2D, 4, 0,
                 p_verts);
}

void RendererPSP::Draw2DTextureR(f32 x0, f32 y0, f32 x1, f32 y1, f32 x2, f32 y2,
                                 f32 x3, f32 y3, f32 s, f32 t) // With Rotation
{
...
void RendererPSP::Draw2DTextureBlit(f32 x, f32 y, f32 width, f32 height, f32 u0,
                                    f32 v0, f32 u1, f32 v1,
  ...
  for (; cur_y < y_end; cur_y += ystep, cur_v += vstep) {
    ...
    for (; cur_x < x_end; cur_x += xstep, cur_u += ustep) {
      ...
      if (cur_u > 512.f || cur_u + ustep > 512.f) {
        s32 off =
            (ustep > 0) ? ((int)cur_u & ~31) : ((int)(cur_u + ustep) & ~31);

        udata += off * GetBitsPerPixel(texture->GetFormat());
        cur_u -= off;
        u_end -= off;
        sceGuTexImage(0, Min<u32>(512, texture->GetCorrectedWidth()),
                      Min<u32>(512, texture->GetCorrectedHeight()),
...
void RendererPSP::SelectPlaceholderTexture(EPlaceholderTextureType type) {
  switch (type) {
  case PTT_WHITE:
    sceGuTexImage(0, kPlaceholderTextureWidth, kPlaceholderTextureHeight,
                  kPlaceholderTextureWidth, gWhiteTexture);
    break;
  case PTT_SELECTED:
    sceGuTexImage(0, kPlaceholderTextureWidth, kPlaceholderTextureHeight,
                  kPlaceholderTextureWidth, gSelectedTexture);
    break;
  case PTT_MISSING:
    sceGuTexImage(0, kPlaceholderTextureWidth, kPlaceholderTextureHeight,
                  kPlaceholderTextureWidth, gPlaceholderTexture);
    break;
  default:
...
#ifdef DAEDALUS_DEBUG_DISPLAYLIST
// Used for Blend Explorer, or Nasty texture
bool RendererPSP::DebugBlendmode(DaedalusVtx *p_vertices, u32 num_vertices,
                                 u32 triangle_mode, u32 render_flags, u64 mux) {
...
#ifdef DAEDALUS_DEBUG_DISPLAYLIST
void RendererPSP::DebugMux(const CBlendStates *states, DaedalusVtx *p_vertices,
                           u32 num_vertices, u32 triangle_mode,
                           u32 render_flags, u64 mux) {
  // Only dump missing_mux when we awant to search for inexact blends aka
  // HighlightInexactBlendModes is enabled. Otherwise will dump lotsa of
  // missing_mux even though is not needed since was handled correctly by auto
  // blendmode thing - Salvy
  //
