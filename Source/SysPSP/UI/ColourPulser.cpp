...
CColourPulser::CColourPulser(c32 dim_colour, c32 bright_colour,
                             u32 cycle_period)
    : mTimeCounter(0), mCyclePeriod(cycle_period), mDimColour(dim_colour),
      mBrightColour(bright_colour), mCurrentColour(mDimColour) {}
