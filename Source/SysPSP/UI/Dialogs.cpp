...
bool CDialog::Render(CUIContext *p_context, const char *message,
                     bool only_dialog) {
  SceCtrlData pad;
  //
  //	Wait until all buttons are release before continuing
  //  We do this to avoid any undesirable button input that can be triggered or
  //  passed whithin the GUI.
  //
