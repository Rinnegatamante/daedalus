...
//
//*****************************************************************************
void CAssemblyWriterX86::PUSH(EIntelReg reg) { EmitBYTE(0x50 | reg); }

//*****************************************************************************
//
//*****************************************************************************
void CAssemblyWriterX86::POP(EIntelReg reg) { EmitBYTE(0x58 | reg); }
...
//
//*****************************************************************************
void CAssemblyWriterX86::ADD_REG_MEM_IDXx4(EIntelReg destreg, void *mem,
                                           EIntelReg idxreg) {
  EmitBYTE(0x03);
...
//
//*****************************************************************************
void CAssemblyWriterX86::JA(u8 off) { EmitWORD((off << 8) | 0x77); }

//*****************************************************************************
//
//*****************************************************************************
void CAssemblyWriterX86::JB(u8 off) { EmitWORD((off << 8) | 0x72); }

//*****************************************************************************
//
//*****************************************************************************
void CAssemblyWriterX86::JAE(u8 off) { EmitWORD((off << 8) | 0x73); }

//*****************************************************************************
//
//*****************************************************************************
void CAssemblyWriterX86::JE(u8 off) { EmitWORD((off << 8) | 0x74); }

//*****************************************************************************
//
//*****************************************************************************
void CAssemblyWriterX86::JNE(u8 off) { EmitWORD((off << 8) | 0x75); }

//*****************************************************************************
//
//*****************************************************************************
void CAssemblyWriterX86::JL(u8 off) { EmitWORD((off << 8) | 0x7C); }

//*****************************************************************************
//
//*****************************************************************************
void CAssemblyWriterX86::JGE(u8 off) { EmitWORD((off << 8) | 0x7D); }

//*****************************************************************************
//
//*****************************************************************************
void CAssemblyWriterX86::JLE(u8 off) { EmitWORD((off << 8) | 0x7E); }

//*****************************************************************************
//
//*****************************************************************************
void CAssemblyWriterX86::JG(u8 off) { EmitWORD((off << 8) | 0x7F); }

//*****************************************************************************
//
//*****************************************************************************
void CAssemblyWriterX86::JMP_SHORT(u8 off) { EmitWORD((off << 8) | 0xeb); }

//*****************************************************************************
//
//*****************************************************************************
CJumpLocation CAssemblyWriterX86::JumpConditionalLong(CCodeLabel target,
                                                      u8 jump_type) {
...
//
//*****************************************************************************
void CAssemblyWriterX86::RET() { EmitBYTE(0xC3); }
...
void CAssemblyWriterX86::MOV8_MEM_BASE_REG(EIntelReg ibase, EIntelReg isrc) {
  DAEDALUS_ASSERT(IsValidMov8Reg(isrc),
                  "Invalid source register for 8 bit move");
  EmitBYTE(0x88);
...
void CAssemblyWriterX86::MOV8_REG_MEM_BASE(EIntelReg idst, EIntelReg ibase) {
  DAEDALUS_ASSERT(IsValidMov8Reg(idst),
                  "Invalid destination register for 8 bit move");
...
//*****************************************************************************
void CAssemblyWriterX86::MOV_MEM_BASE_OFFSET32_REG(EIntelReg ibase, s32 offset,
                                                   EIntelReg isrc) {
  EmitBYTE(0x89);
...
//*****************************************************************************
void CAssemblyWriterX86::MOV_MEM_BASE_OFFSET8_REG(EIntelReg ibase, s8 offset,
                                                  EIntelReg isrc) {
  EmitBYTE(0x89);
...
//
//*****************************************************************************
void CAssemblyWriterX86::MOV_MEM_BASE_OFFSET_REG(EIntelReg ibase, s32 offset,
                                                 EIntelReg isrc) {
  if (offset == 0) {
...
//*****************************************************************************
void CAssemblyWriterX86::MOV_REG_MEM_BASE_OFFSET32(EIntelReg idst,
                                                   EIntelReg ibase,
                                                   s32 offset) {
  EmitBYTE(0x8B);
...
//*****************************************************************************
void CAssemblyWriterX86::MOV_REG_MEM_BASE_OFFSET8(EIntelReg idst,
                                                  EIntelReg ibase, s8 offset) {
  EmitBYTE(0x8B);
...
//
//*****************************************************************************
void CAssemblyWriterX86::MOV_REG_MEM_BASE_OFFSET(EIntelReg idst,
...
//
//*****************************************************************************
void CAssemblyWriterX86::FSQRT() { EmitWORD(0xfad9); }

//*****************************************************************************
//
//*****************************************************************************
void CAssemblyWriterX86::FCHS() { EmitWORD(0xe0d9); }
...
// fnstsw      ax
//*****************************************************************************
void CAssemblyWriterX86::FNSTSW() { EmitWORD(0xe0df); }
...
//
//*****************************************************************************
void CAssemblyWriterX86::FINCSTP() { EmitWORD(0xf7d9); }

//*****************************************************************************
//
//*****************************************************************************
void CAssemblyWriterX86::FSQRTp() { EmitWORD(0xfad9); }

//*****************************************************************************
//
//*****************************************************************************
void CAssemblyWriterX86::FCHSp() { EmitWORD(0xe0d9); }
