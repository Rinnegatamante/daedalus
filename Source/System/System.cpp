...
static bool InitAudioPlugin() {
  ...
  DAEDALUS_ASSERT(gAudioPlugin == NULL,
                  "Why is there already an audio plugin?");
#endif
...
static bool InitGraphicsPlugin() {
  ...
  DAEDALUS_ASSERT(
      ...
      "The graphics plugin should not be initialised at this point");
#endif
...
static const RomEntityEntry gRomInitTable[] = {
    ...
    {"CSynchroniser", CSynchroniser::InitialiseSynchroniser,
     CSynchroniser::Destroy},
#endif
};
