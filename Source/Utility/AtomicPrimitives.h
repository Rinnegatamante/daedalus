...
inline u32 AtomicIncrement(volatile u32 *ptr) { return _AtomicIncrement(ptr); }

inline u32 AtomicDecrement(volatile u32 *ptr) { return _AtomicDecrement(ptr); }
...
inline u32 AtomicBitSet(volatile u32 *ptr, u32 and_bits, u32 or_bits) {
  ...
  } while (_InterlockedCompareExchange(reinterpret_cast<volatile LONG *>(ptr),
                                       new_value, orig_value) != orig_value);
