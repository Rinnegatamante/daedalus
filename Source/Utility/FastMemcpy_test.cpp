...
class MemcpyByteSwapTest
    : public ::testing::TestWithParam<::std::tr1::tuple<u32, u32, u32>> {
protected:
  virtual void SetUp() {
    for (u32 i = 0; i < 64; ++i)
      mSrc[i] = i;
...
static void memcpy_byteswap_reference(void *dst, u32 dst_off, const void *src,
                                      u32 src_off, size_t size) {
