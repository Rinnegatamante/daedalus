...
//
//*****************************************************************************
CROMFileMemory::~CROMFileMemory() = default;
...
#ifdef DAEDALUS_PSP
  //
  // Allocate large memory heap for SLIM+ (32Mb) Used for ROM Buffer and ROM
  // Cache Otherwise allocate small memory heap for PHAT (2Mb) Used for ROM
  // cache only
  //
  if (PSP_IS_SLIM) {
