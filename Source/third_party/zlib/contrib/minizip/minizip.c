...
int check_exist_file(filename) const char *filename;
{
  FILE *ftestexist;
  int ret = 1;
...
void do_banner() {
  printf("MiniZip 1.1, demo of zLib + MiniZip64 package, written by Gilles "
         "Vollant\n");
...
void do_help() {
  printf("Usage : minizip [-o] [-a] [-0 to -9] [-p password] [-j] file.zip "
         "[files_to_add]\n\n"
